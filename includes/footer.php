<section class="container-fluid web">
    <div class="container ">
        <div class="row">
            <div class="col-md-5">
                <a href="/"> <img src="../images/hyjg.png" class="logo-set-image" alt=""></a>
            ...
            <div class="col-lg-8">
                <p>
                <p style="margin-bottom: 32px; color:#000000 !important;"><strong>Disclaimer:</strong> Australian Book Publishing is an independent entity helping self-reliant authors with book publishing and marketing solutions. We believe in ethical business practices and abide by US Federal and State Laws.</p>
                </p>
            </div>
            <div class="col-lg-4">
