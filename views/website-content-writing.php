...
<head>
    ...
    <title>Professional Book Editing and Proofreading Service for Authors</title>
    <meta name="keywords" content="book editing and proofreading service">
    <meta name="description" content="We offer professional book editing, proofreading and formatting services for self-publishers, traditional publishers, and academic authors. We also provide ebook conversion services and graphic design services." />
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3 class="text3">Utilize Our Web Content Writing Services to Get Compelling</h3>
                    <h1 class="text4"><span style="color: #ef0001;">Web Content that Converts Visitors into Buyers</span></h1>
                    <p class="mnbvcx">We can't judge a book by its cover, but the one with the best book cover design sells the most. Our design specialists at StorylinePublisher know how to design an engaging book cover for your book, thereby helping you increase your book sales and generate revenues.</p>
    ...
    <div class="container column1 zxccvbb">
        <div class="row">
            ...
            <div class="col-md-6 ASDFGH">
                <h2>Content That Highlights Your Work In The Right Way
                </h2>
                <p>Our skilled writers are skilled in creating engaging content for your website that entices visitors to come back for more. The content of your website conveys an important message to the audience about your brand and business. Ensure to hire competent, professional writers to produce engaging and relevant content for your website. Hire our professional content writing company today to enhance your website's rank and credibility!</p>
    ...
    <!-- Column 1 End -->
    <?php include_once("why-choose-global.php") ?>
