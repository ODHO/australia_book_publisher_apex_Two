        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3 class="text3">Our Blog Writing Company Creates Blogs</h3>
                    <h1 class="text4"><span style="color: #ef0001;">That Leave the Readers Wanting More</span></h1>
