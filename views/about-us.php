...
<!-- Column 1 Start -->
    ...
    <div class="container column1 zxccvbb" id="zxccvbbccc">
        <div class="row">
            <div class="col-lg-6">
                <img class="bookSize" src="images/images-img.png">
            </div>
            <div class="col-lg-6">
...
<div class="main-about-sec-net-two">
  <div class="container bnmn">
        <div class="row">
            <div class="col-md column3 grehgrgnrui">
                <h1 class="heading1">Providing Perfect Solutions To Clients Worldwide</h1>
                <p class="para">We offer a vast range of services for authors, including book writing, editing, proofreading, publishing, cover design, and marketing.</p>
            </div>
        </div>
    </div>
    ...
    <section class="carousel right container-fluid">
        ...
        <div class="row">
            <div class="col-md column2">
                <h2>Book a Call with Our Consultant to Get <br> Help  with Your Book</h2>
