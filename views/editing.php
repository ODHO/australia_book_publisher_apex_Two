...
<body>
   ...
   <section class="container-fluid bannimg">
        ...
        <div class="row">
            ...
            <h3 class="text3">Craft And Publish An Error-Free Book</h3>
                <h1 class="text4"><span style="color: #ef0001;">With Our Book Editing Company</span></h1>
                    <p class="mnbvcx">No more truncated or lousy manuscripts! Hire StorylinePublisher’s professional
                    book editing services <br> to perfect your manuscript and polish your rough idea into a masterpiece.</p>
