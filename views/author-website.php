        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3 class="text3">Set Up An Author Website to</h3>
                    <h1 class="text4"><span style="color: #ef0001;">Showcase Your Worth as An Author</span></h1>
                    <p class="mnbvcx">Do you want to make your name as an author? With a unique author website - that includes features to achieve larger visibility
for you and your work - we will promote your story on your behalf throughout the world. We're here to assist you in achieving
the spotlight you've always desired.</p>
    ...
    <div class="container column1 zxccvbb">
        <div class="row">
            ...
            <div class="col-md-6 ASDFGH">
                <h2>We Make An Author Website For You And Assist You In Becoming The Bestseller!</h2>
                <p>Are you not getting the attention you deserve? Tell the readers who you truly are, using our author website builder services. You can be the next published author with the potential to achieve your desired marketing goals. Our skilled developers will create your Author's Website and promote your book on various platforms to engage readers from around the world.</p>
