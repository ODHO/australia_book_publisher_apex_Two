...
<body>
    ...
    <section class="container-fluid bannimg">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    <h1 class="text3">Let’s Achieve More Through Our Book <span>Publishing Service</span></h1>
                  <h4 style="color: white;">
                  We Help You Gain: 
                    Acknowledgment and Fame <br>
                    Credibility Building 
                  </h4>
                    <h5 class="text7">Spike Up Book Sales </h5>
                    <ul class="list">
                        ...
                        <li>A Steady Stream of Passive Income </li>
                        <li>Publish your book in less than 30 days!</li>
                    ...
                    <div class="form-container" id="form-container">
                        <form action="/email-handler/" method="post" id="ajax_contact" class="tab details">
                                ...
                                <div id="secondForm">
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" id="exampleInputAbout1" rows="4"
                                            placeholder="I am looking for ...." name="brief"></textarea>
                                    </div>
